...
<form method="post" novalidate enctype="multipart/form-data" action="http://www.formstack.com/forms/index.php" class="fsForm fsSingleColumn fsMaxCol1" id="fsForm1567980">
	...
	<input type="hidden" name="hidden_fields" id="hidden_fields1567980" value="" />
	<input type="hidden" name="_submit" value="1" />
	<input type="hidden" name="incomplete" id="incomplete1567980" value="" />
	...
	<div class="fsPage" id="fsPage1567980-1">
	...
	<div class="fsRowBody fsCell fsFieldCell  fsFirst fsLast fsLabelVertical  fsSpan100 " id="fsCell21499659">
	<label id="label21499659" class="fsLabel" for="field21499659">Country                                            </label>
	<select id="field21499659" name="field21499659" size="1"   class="fsField "  >
<option value="" >&nbsp;</option>
...
<option value="Côte_d&#039;Ivoire" >Côte_d&#039;Ivoire</option>
...
<option value="Zimbabwe" >Zimbabwe</option>
	...
	<div id="fsRow1567980-5" class="fsRow fsFieldRow fsLastRow">
	<div class="fsRowBody fsCell fsFieldCell  fsFirst fsLast fsLabelVertical  fsSpan100 " id="fsCell21499614">
	<label id="label21499614" class="fsLabel" for="field21499614">State                                            </label>
	<select id="field21499614" name="field21499614" size="1"   class="fsField "  >
...
<option value="Wyoming" >Wyoming</option>
	...
	<div class="fsRowBody fsCell fsFieldCell  fsFirst fsLast fsLabelVertical  fsSpan100 " id="fsCell21499229">
	<label id="label21499229" class="fsLabel fsRequiredLabel" for="field21499229">Tell us a little about your business<span class="fsRequiredMarker">*</span>                                            </label>
	<textarea id="field21499229" name="field21499229" rows="4" cols="50" required   class="fsField fsRequired " aria-required="true"  ></textarea>
	</div>
	</div>
	...
	<div id="fsSubmit1567980" class="fsSubmit fsPagination" >
	<button type="button" id="fsPreviousButton1567980" class="fsPreviousButton" value="Previous Page" style="display:none; "><span class="fsFull">Previous</span><span class="fsSlim">&larr;</span></button>
	<button type="button" id="fsNextButton1567980" class="fsNextButton" value="Next Page" style="display:none; "><span class="fsFull">Next</span><span class="fsSlim">&rarr;</span></button>
	<input id="fsSubmitButton1567980" class="fsSubmitButton button" style="display:block;" type="submit" value="Submit" />
	<div class="clear"></div>
	</div>
	...
	var form1567980 = new Formstack.Form(1567980);
	form1567980.logicFields = [];
	form1567980.calcFields = [];
	form1567980.init();
	window.form1567980 = form1567980;
	};
	</script>
</form>
	</div>
